 ...
 */
public class SceneP3 extends JFrame implements GLSceneDrawer,
...

{
	...
	public SceneP3() {
		super("CS 4620 Scene Assignment / Problem 3");
	...
	public void draw(GLAutoDrawable drawable, CameraController cameraController)
	{
		...
		if (!sceneViewPanel.isLightingMode())
		{
			...
			flatColorProgram.setProjection(gl, cameraController.getProjection());
			
			// give program info about all lights in the scene
			scene.setupLighting(gl, flatColorProgram, cameraController.getView());
			flatColorProgram.setLightAmbientIntensity(gl, lightSettingPanel.getAmbient());
	...
	public void actionPerformed(ActionEvent e) {
		...
		ActionPerformedSceneP3Runnable runnable = new ActionPerformedSceneP3Runnable(this, e, filename);
...
class ActionPerformedSceneP3Runnable implements GLRunnable {
	
	SceneP3 problem;
	ActionEvent e;
	String filename;
	
	public ActionPerformedSceneP3Runnable(SceneP3 problem, ActionEvent e)
	{
	...
	public ActionPerformedSceneP3Runnable(SceneP3 problem, ActionEvent e, String filename)
	{
		this.problem = problem;
		this.e = e;
