...
public class EarthMaterial extends TextureMaterial {

	public EarthMaterial() {
		super("data/textures/earth.jpg");
	...
	public static EarthMaterial fromYamlObject(Object yamlObject)
	{
		if (!(yamlObject instanceof Map))
			throw new RuntimeException("yamlObject not a Map");
		Map<?, ?> matMap = (Map<?, ?>)yamlObject;
		
		EarthMaterial mat = new EarthMaterial();
