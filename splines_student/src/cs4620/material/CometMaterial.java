...
public class CometMaterial extends TextureMaterial {

	public CometMaterial() {
		super("data/textures/phobos.jpg");
	...
	public static CometMaterial fromYamlObject(Object yamlObject)
	{
		if (!(yamlObject instanceof Map))
			throw new RuntimeException("yamlObject not a Map");
		Map<?, ?> matMap = (Map<?, ?>)yamlObject;
		
		CometMaterial mat = new CometMaterial();
