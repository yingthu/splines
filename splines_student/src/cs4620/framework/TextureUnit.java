...
/*
 * This class is the interface to the OpenGL texture units.
 * It allows binding textures to the different texture units.
 */
public class TextureUnit {
	...
	private static synchronized void initialize(GL2 gl)
	{
		if (!initialized)
		{
			...
			gl.glGetIntegerv(GL2.GL_MAX_TEXTURE_UNITS, countv, 0);
			count = countv[0];
	...
	public void bindToUniform(GL2 gl, Uniform target) {
		target.set1Int(gl, id - GL2.GL_TEXTURE0);
	}
